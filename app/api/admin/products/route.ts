...
import { productCreateSchema, productListQuerySchema } from '@/lib/validators/product'
import { productWithRelations, serializeProduct } from '@/lib/serializers'
import { PRODUCT_SORT_MAP, buildProductCreateData } from '../../products/utils'
...
export async function GET(request: NextRequest) {
  ...
  try {
    const query = productListQuerySchema.parse(Object.fromEntries(request.nextUrl.searchParams.entries()))
