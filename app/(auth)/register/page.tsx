    ...
    <div className="min-h-[80dvh] flex items-center justify-center bg-[--background]">
      <div className="grid max-w-5xl w-full grid-cols-1 md:grid-cols-2 gap-8 p-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-8">Bli klar for å handle hos oss.</p>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="+47 123 45 678" inputMode="tel" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            ...
                            >
                              <div className="py-2">
                                ...
                                {!isSearching && addressResults.length === 0 && addressFetchError ? (
                          ...
                          {addressId ? (
                            <p className="text-xs text-muted-foreground">
                              ...
                              <button type="button" className="text-xs underline ml-1" onClick={resetAddressSelection}>
                                Endre
                              </button>
                            </p>
                          ) : null}
                        ...
                        {form.formState.errors.addressId ? (
                          <p className="text-xs text-destructive mt-1">{form.formState.errors.addressId.message}</p>
                        ) : null}
                      </FormItem>
                    )}
                  />
